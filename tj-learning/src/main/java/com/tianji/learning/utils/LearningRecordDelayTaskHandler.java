...
public class LearningRecordDelayTaskHandler {
    ...
    static ThreadPoolExecutor poolExecutor = new ThreadPoolExecutor(6,12,60, TimeUnit.SECONDS,new LinkedBlockingQueue<>(10));


    //项目启动后 当前类实例化 属性注入之后 方法就会运行 一般用来做初始化操作
    @PostConstruct
    public void init(){
        log.info("LearningRecordDelayTaskHandler  init方法执行了");
        //开启新线程执行handleDelayTask方法
